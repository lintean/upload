<template>
  <a-drawer width="460" :closable="false" @close="close" :visible="groupVisible">
    <div slot="title">
      <span>查看群组</span>
    ...
    <!-- 群组列表 -->
    <div>
      <span v-if="TaNoGrounp">该资源还没有群组，请先新建，再添加</span>
    </div>
    ...
    >
      ...
      >
        ...
        <el-button type="primary" size="mini" @click="addUserToGrounp()" style="float:right">添加</el-button>
      </div>
