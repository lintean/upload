<template>
  <a-drawer title="目录属性" getContainer='section' width="270" :mask="false" @close="close" :visible="dirMetaVisible">
	...
	<el-row v-if="dirMeta.created_time == null"> </el-row>
    <el-row v-else>{{dirMeta.created_time.substr(0, 16)}}</el-row>
